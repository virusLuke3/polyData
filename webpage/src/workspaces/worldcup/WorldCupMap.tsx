  ...
  return {
    ...
    layers: [
      ...
      },
      {
        ...
        paint: {
          'line-color': '#343a3a',
          'line-opacity': ['interpolate', ['linear'], ['zoom'], 1.5, 0.42, 3.5, 0.78, 5, 0.92],
          'line-width': ['interpolate', ['linear'], ['zoom'], 1.5, 0.42, 3.5, 0.88, 6, 1.35],
          'line-dasharray': [3, 2],
        },
      },
      {
        ...
        paint: {
          'line-color': '#4d5554',
          'line-opacity': 0.88,
          'line-width': ['interpolate', ['linear'], ['zoom'], 1.5, 0.85, 4, 1.35, 6, 2],
        },
      },
      {
        ...
        source: 'carto',
        'source-layer': 'place',
        filter: ['all', ['==', 'class', 'country'], ['has', 'name']],
        layout: {
          'text-field': '{name}',
          'text-font': ['Montserrat SemiBold', 'Open Sans Bold', 'Noto Sans Regular'],
          'text-size': ['interpolate', ['linear'], ['zoom'], 1.5, 12, 4, 17],
          'text-transform': 'uppercase',
          'text-letter-spacing': 0.04,
        },
        paint: {
          'text-color': 'rgba(150, 154, 154, 0.46)',
      ...
      },
      {
        ...
        'source-layer': 'place',
        minzoom: 2.4,
        filter: ['all', ['in', 'class', 'city', 'town'], ['has', 'name']],
        layout: {
          'text-field': '{name}',
          'text-font': ['Montserrat Regular', 'Open Sans Regular', 'Noto Sans Regular'],
          'text-size': ['interpolate', ['linear'], ['zoom'], 2.4, 9, 5, 13],
          'text-max-width': 8,
        },
        paint: {
          'text-color': 'rgba(156, 158, 158, 0.62)',
